...
/*slider*/
jQuery("#wowslider-container1").wowSlider({effect:"basic",prev:"",next:"",duration:16*100,delay:29*100,width:1624,height:400,autoPlay:true,autoPlayVideo:false,playPause:false,stopOnHover:true,loop:false,bullets:1,caption:false,captionEffect:"none",controls:true,controlsThumb:false,responsive:1,fullScreen:true,gestures:2,onBeforeStep:0,images:0});

/*video*/
function toggle1(){
  var video_watch = document.querySelector(".video_watch")
