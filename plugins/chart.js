...
!(function (t, e) {
    ...
    const fi = (t) => 0 === t || 1 === t,
        ...
        mi = {
            ...
            easeInOutExpo: (t) => (fi(t) ? t : t < 0.5 ? 0.5 * Math.pow(2, 10 * (2 * t - 1)) : 0.5 * (2 - Math.pow(2, -10 * (2 * t - 1)))),
            ...
            easeInOutBounce: (t) => (t < 0.5 ? 0.5 * mi.easeInBounce(2 * t) : 0.5 * mi.easeOutBounce(2 * t - 1) + 0.5),
        },
        xi = "transparent",
        bi = {
    ...
    class Xi extends Ei {
        ...
        update(t, e, i) {
            ...
            n.beforeUpdate(),
                ...
                n._dataLimitsCached || (n.beforeDataLimits(), n.determineDataLimits(), n.afterDataLimits(), (n._range = Be(n, n.options.grace)), (n._dataLimitsCached = !0)),
                n.beforeBuildTicks(),
            ...
            n._convertTicksToLabels(a ? Ni(n.ticks, s) : n.ticks),
                ...
                o.display && (o.autoSkip || "auto" === o.source) && ((n.ticks = Bi(n, n.ticks)), (n._labelSizes = null)),
        ...
        calculateLabelRotation() {
            ...
            (a = e.offset ? t.maxWidth / n : f / (n - 1)),
                d + 6 > a &&
                    ...
                    (l = Math.sqrt(d * d + u * u)),
                    (c = It(Math.min(Math.asin(Math.min((h.highest.height + 6) / a, 1)), Math.asin(Math.min(r / l, 1)) - Math.asin(u / l)))),
        ...
        !(function (t, e, i) {
            ...
            for (let h = 0; h < n - 1; ++h)
                (l = c),
                    ...
                    l &&
                        c &&
                        (At(e[h], 0, ln) ? (i[h] = i[h + 1] = 0) : ((o = i[h] / e[h]), (s = i[h + 1] / e[h]), (r = Math.pow(o, 2) + Math.pow(s, 2)), r <= 9 || ((a = 3 / Math.sqrt(r)), (i[h] = o * a * e[h]), (i[h + 1] = s * a * e[h]))));
        })(t, o, s),
            (function (t, e, i = "x") {
                const n = hn(i),
                    o = t.length;
            ...
            (function (t, e) {
                ...
                for (i = 0, n = t.length; i < n; ++i)
                    (a = s),
                        (s = r),
                        (r = i < n - 1 && Gt(t[i + 1], e)),
                        s && ((o = t[i]), a && ((o.cp1x = fn(o.cp1x, e.left, e.right)), (o.cp1y = fn(o.cp1y, e.top, e.bottom))), r && ((o.cp2x = fn(o.cp2x, e.left, e.right)), (o.cp2y = fn(o.cp2y, e.top, e.bottom))));
            })(t, i);
    }
    function pn(t, e, i, n) {
    ...
    function vn(t) {
        return "angle" === t ? { between: Ht, compare: Bt, normalize: Wt } : { between: (t, e, i) => t >= Math.min(e, i) && t <= Math.max(i, e), compare: (t, e) => t - e, normalize: (t) => t };
    }
    ...
    function Mn(t, e, i) {
        ...
        for (let t = h, i = h; t <= d; ++t)
            (m = e[t % a]),
                m.skip || ((p = c(m[n])), p !== x && ((b = l(p, o, s)), null === _ && y() && (_ = 0 === r(p, o) ? t : i), null !== _ && v() && (g.push(wn({ start: _, end: t, loop: u, count: a, style: f })), (_ = null)), (i = t), (x = p)));
    ...
    function $n(t, e, i) {
        ...
        let s = n.get(o);
        if (!s) {
            (s = { resolver: qi(e, i), subPrefixes: i.filter((t) => !t.toLowerCase().includes("hover")) }), n.set(o, s);
        }
        return s;
    }
    ...
    class to {
        constructor(t, e) {
            ...
            (this.id = j()),
                ...
                (Qn[n.id] = n),
                l && c ? (a.listen(n, "complete", qn), a.listen(n, "progress", Kn), n._initialize(), n.attached && n.update()) : console.error("Failed to create chart: can't acquire context from the given item");
        }
        get aspectRatio() {
            const {
            ...
            i &&
                ...
                J(s, (i) => {
                    ...
                    if (a in n && n[a].type === l) c = n[a];
                        ...
                        (c = new (An.getScale(l))({ id: a, type: l, ctx: t.ctx, chart: t })), (n[c.id] = c);
                    }
                    c.init(s, e);
                }),
                J(o, (t, e) => {
        ...
        render() {
            const t = this;
            !1 !== t.notifyPlugins("beforeRender", { cancelable: !0 }) && (a.has(t) ? t.attached && !a.running(t) && a.start(t) : (t.draw(), qn({ chart: t })));
        }
        draw() {
            const t = this;
            let e;
        ...
        _drawDataset(t) {
            ...
            !1 !== e.notifyPlugins("beforeDatasetDraw", s) &&
                (Zt(i, { left: !1 === n.left ? 0 : o.left - n.left, right: !1 === n.right ? e.width : o.right + n.right, top: !1 === n.top ? 0 : o.top - n.top, bottom: !1 === n.bottom ? e.height : o.bottom + n.bottom }),
                t.controller.draw(),
                Qt(i),
                (s.cancelable = !1),
    ...
    (ho.id = "bar"),
        (ho.defaults = { datasetElementType: !1, dataElementType: "bar", categoryPercentage: 0.8, barPercentage: 0.9, grouped: !0, animations: { numbers: { type: "number", properties: ["x", "y", "base", "width", "height"] } } }),
        (ho.overrides = { interaction: { mode: "index" }, scales: { _index_: { type: "category", offset: !0, grid: { offset: !0 } }, _value_: { type: "linear", beginAtZero: !0 } } });
    class uo extends Ri {
        initialize() {
    ...
    (uo.id = "bubble"),
        (uo.defaults = { datasetElementType: !1, dataElementType: "point", animations: { numbers: { type: "number", properties: ["x", "y", "borderWidth", "radius"] } } }),
        (uo.overrides = { scales: { x: { type: "linear" }, y: { type: "linear" } }, plugins: { tooltip: { callbacks: { title: () => "" } } } });
    class fo extends Ri {
        constructor(t, e) {
    ...
    (xo.id = "radar"),
        (xo.defaults = { datasetElementType: "line", dataElementType: "point", indexAxis: "r", showLine: !0, elements: { line: { fill: "start" } } }),
        (xo.overrides = { aspectRatio: 1, scales: { r: { type: "radialLinear" } } });
    class bo extends go {}
    (bo.id = "scatter"),
        (bo.defaults = { showLine: !1, fill: !1 }),
        (bo.overrides = { interaction: { mode: "point" }, plugins: { tooltip: { callbacks: { title: () => "", label: (t) => "(" + t.label + ", " + t.formattedValue + ")" } } }, scales: { x: { type: "linear" }, y: { type: "linear" } } });
    ...
    function ko(t, e, i, n) {
        ...
        o.borderWidth &&
            (s ? ((t.lineWidth = 2 * o.borderWidth), (t.lineJoin = "round")) : ((t.lineWidth = o.borderWidth), (t.lineJoin = "bevel")),
            e.fullCircles &&
                (function (t, e, i) {
        ...
        Lo && 1 === e.segments.length
            ...
            : (function (t, e, i, n) {
                  const { segments: o, options: s } = e,
                      a = Ao(e);
                  for (const r of o) Po(t, s, r.style), t.beginPath(), a(t, e, r, { start: i, end: i + n - 1 }) && t.closePath(), t.stroke();
              })(t, e, i, n);
    }
    class Eo extends Ei {
        constructor(t) {
    ...
    (Eo.id = "line"),
        (Eo.defaults = { borderCapStyle: "butt", borderDash: [], borderDashOffset: 0, borderJoinStyle: "miter", borderWidth: 3, capBezierPoints: !0, cubicInterpolationMode: "default", fill: !1, spanGaps: !1, stepped: !1, tension: 0 }),
    ...
    (zo.id = "point"),
        (zo.defaults = { borderWidth: 1, hitRadius: 1, hoverBorderWidth: 1, hoverRadius: 4, pointStyle: "circle", radius: 3, rotation: 0 }),
            ...
            t.data.datasets.forEach((e, o) => {
                ...
                let h,
                    { start: d, count: u } = (function (t, e) {
                        ...
                        return l && (o = Nt(oe(e, s.axis, a).lo, 0, i - 1)), (n = c ? Nt(oe(e, s.axis, r).hi + 1, o, i) - o : i - o), { start: o, count: n };
                    })(r, l);
                if (u <= 4 * n) Xo(e);
                else {
                    switch (
    ...
    function Qo(t) {
        return (t.scale || {}).getPointPositionForValue
            ? (function (t) {
                  ...
                  let l, c, h;
                  if (((h = "start" === i ? a : "end" === i ? r : U(i) ? i.value : e.getBaseValue()), n.grid.circular)) return (c = e.getPointPositionForValue(0, a)), new Zo({ x: c.x, y: c.y, radius: e.getDistanceFromCenterForValue(h) });
                ...
                for (const t of n) {
                    ...
                    for (const e of r) {
                        const r = as(i, s[e.start], s[e.end], e.loop),
                            l = Mn(t, o, r);
                        for (const t of l) a.push({ source: t, target: e, start: { [i]: rs(n, r, "start", Math.max) }, end: { [i]: rs(n, r, "end", Math.min) } });
                    }
                }
                return a;
            })(i, n, o);
    ...
    function ds(t, e, i) {
        ...
        n &&
            ...
            (function (t, e) {
                ...
                t.save(),
                    "x" === l && s !== o && (ss(t, n, a.top), hs(t, { line: i, target: n, color: o, scale: r, property: l }), t.restore(), t.save(), ss(t, n, a.bottom)),
        ...
        afterDatasetsUpdate(t, e, i) {
            ...
            for (a = 0; a < n; ++a)
                (s = t.getDatasetMeta(a)),
                    (r = s.dataset),
                    (l = null),
                    r && r.options && r instanceof Eo && (l = { visible: t.isDatasetVisible(a), index: a, fill: Go(r, a, n), chart: t, axis: s.controller.options.indexAxis, scale: s.vScale, line: r }),
                    (s.$filler = l),
                    o.push(l);
    ...
    class Os extends Ei {
        ...
        drawTitle(t, e, i) {
            ...
            if (s) {
                ...
                for (t.x = Ps(n, i.titleAlign, i), e.textAlign = c.textAlign(i.titleAlign), e.textBaseline = "middle", a = Fe(i.titleFont), r = i.titleSpacing, e.fillStyle = i.titleColor, e.font = a.string, l = 0; l < s; ++l)
        ...
        drawBody(t, e, i) {
            ...
            let m, x, b, _, y, v, w;
            for (
                e.textAlign = a, e.textBaseline = "middle", e.font = h.string, t.x = Ps(n, p, i), e.fillStyle = i.bodyColor, J(n.beforeBody, g), u = r && "right" !== p ? ("center" === a ? c / 2 + 1 : c + 2) : 0, _ = 0, v = o.length;
                _ < v;
                ++_
            ) {
        ...
        drawFooter(t, e, i) {
            ...
            if (s) {
                ...
                for (t.x = Ps(n, i.footerAlign, i), t.y += i.footerMarginTop, e.textAlign = l.textAlign(i.footerAlign), e.textBaseline = "middle", a = Fe(i.footerFont), e.fillStyle = i.footerColor, e.font = a.string, r = 0; r < s; ++r)
            ...
            const o = (function (t, e) {
                ...
                (M = Math.ceil(p / k) - Math.floor(g / k)),
                    ...
                    m && x && o && Lt((a - s) / o, k / 1e3)
                        ? ((M = Math.min((a - s) / k, c)), (k = (a - s) / M), (v = s), (w = a))
                        : b
        ...
        buildTicks() {
            const t = this,
                ...
                i = (function (t, e) {
                    ...
                    do {
                        o.push({ value: s, major: Fs(s) }), ++r, 10 === r && ((r = 1), ++a, (l = a >= 0 ? 1 : l)), (s = Math.round(r * Math.pow(10, a) * l) / l);
                    } while (a < i || (a === i && r < n));
                    const c = q(t.max, s);
                        ...
                        if (0 !== i) {
                            ...
                            !(function (t, e, i, n) {
                                ...
                                (!s && !n) ||
                                    ...
                                    !r ||
                                    i < 0 ||
                                    (o.save(), (o.strokeStyle = a), (o.lineWidth = r), o.setLineDash(e.borderDash), (o.lineDashOffset = e.borderDashOffset), o.beginPath(), js(t, i, s, n), o.closePath(), o.stroke(), o.restore());
                            })(t, n, r, s);
                        }
                    }),
                n.display)
    ...
    (Ys.id = "radialLinear"),
        ...
        (Ys.defaultRoutes = { "angleLines.color": "borderColor", "pointLabels.color": "color", "ticks.color": "color" }),
            ...
            return (
                ...
                (t._majorUnit =
                    n.major.enabled && "year" !== t._unit
                        ? (function (t) {
                              for (let e = Xs.indexOf(t) + 1, i = Xs.length; e < i; ++e) if (Us[Xs[e]].common) return Xs[e];
                          })(t._unit)
                        : void 0),
                t.initOffsets(o),
                e.reverse && a.reverse(),
